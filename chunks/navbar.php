<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">Amaravati Foods</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/AmaravatiEssentials/index.php" class="hvr-grow">Home</a></li>
		        ...
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91-8985229666. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/AmaravatiEssentials/index.php">Home</a></li>
	        <li><a href="/AmaravatiEssentials/about-restro-girls.php">About Us</a></li>
