<section class="ffooter">
		<footer class="page-footer">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Nakka H.H. TirumalaRao,Sileru,Andhra Pradesh</p>
                <p class="grey-text text-lighten-4">Phone : 8985229666</p>
              </div>
          ...
          <div class="footer-copyright">
            <div class="container">
            © 2024 Copyright @ Amaravati Foods
